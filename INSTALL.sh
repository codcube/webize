...
command -v apk && sudo apk add alpine-sdk build-base coreutils gcompat libcap-setcap linux-headers ruby ruby-dev ruby-zstd-ruby openssl-dev findutils grep libxslt-dev poppler-utils taglib-dev py3-pygments p11-kit-trust yaml-dev
